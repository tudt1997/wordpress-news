...
do_action( 'add_meta_boxes', 'link', $conn );
 ...
 */
do_action( 'add_meta_boxes_link', $conn );

/** This action is documented in wp-admin/edit-form-advanced.php */
do_action( 'do_meta_boxes', 'link', 'normal', $conn );
/** This action is documented in wp-admin/edit-form-advanced.php */
do_action( 'do_meta_boxes', 'link', 'advanced', $conn );
/** This action is documented in wp-admin/edit-form-advanced.php */
do_action( 'do_meta_boxes', 'link', 'side', $conn );
...
<div class="inside">
	<input type="text" name="link_name" size="30" maxlength="255" value="<?php echo esc_attr($conn->link_name); ?>" id="link_name" />
...
<div class="inside">
	<input type="text" name="link_url" size="30" maxlength="255" class="code" value="<?php echo esc_attr($conn->link_url); ?>" id="link_url" />
...
<div class="inside">
	<input type="text" name="link_description" size="30" maxlength="255" value="<?php echo isset($conn->link_description) ? esc_attr($conn->link_description) : ''; ?>" id="link_description" />
...
$side_meta_boxes = do_meta_boxes( 'link', 'side', $conn );
...
do_meta_boxes(null, 'normal', $conn);

do_meta_boxes(null, 'advanced', $conn);
